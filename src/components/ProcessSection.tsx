...
const ProcessSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-20 opacity-[0.04] hidden lg:block">
        <CompassIcon size={400} className="text-accent animate-compass-spin" />
      </div>
              ...
              <ScrollReveal key={i} delay={i * 0.08} direction="right">
                <div className="flex gap-6 md:gap-8 group">
                  ...
                  <div className="relative shrink-0">
                    <div className="w-[3.2rem] h-[3.2rem] md:w-[3.7rem] md:h-[3.7rem] rounded-full bg-primary-foreground/5 border-2 border-accent/40 flex items-center justify-center group-hover:border-accent group-hover:bg-accent/10 transition-all duration-500">
