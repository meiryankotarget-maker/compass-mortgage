                  ...
                  {differentiators.map((item, i) => {
                    ...
                    return (
                      <motion.button
                        ...
                        style={{ left: 180 + x, top: 180 + y, transform: "translate(-50%, -50%)" }}
                        ...
                        whileTap={{ scale: 0.95 }}
                      >
                        <div className={`w-12 h-12 rounded-full flex items-center justify-center border-2 transition-all duration-300 ${isActive ? "bg-accent border-accent shadow-lg shadow-accent/30" : "bg-card/80 backdrop-blur-sm border-border/50 group-hover:border-accent/60"}`}>
                  ...
                  {differentiators.map((item, i) => {
                    ...
                    return (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                      >
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all duration-300 ${isActive ? "bg-accent border-accent shadow-lg shadow-accent/30" : "bg-card/80 backdrop-blur-sm border-border/50 group-hover:border-accent/60"}`}>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {differentiators.map((item, i) => (
                    <button
                      key={i}
                      onClick={() => handleIconClick(i)}
                      className={`flex items-center gap-2 p-3 rounded-lg transition-colors duration-300 text-right ${activeIndex === i ? "bg-accent/15 ring-1 ring-accent/40" : "bg-secondary/50 hover:bg-secondary"}`}
                    >
