            ...
            <div className="order-1 lg:order-2">
              ...
              <ScrollReveal delay={0.1}>
                <p className="text-muted-foreground leading-relaxed mb-6">
                  אני יועץ משכנתאות ומתכנן פיננסי עם ניסיון עשיר משני צידי המפה – הן מהמערכת הבנקאית והן מהשוק הפרטי. אני מכיר את הבנקים מבפנים, יודע בדיוק איפה יש מרחב לנהל מו"מ – ואיפה אין. זה היתרון שלכם – לדעת מראש לאן הדרך מובילה.
לכל לקוח אני בונה מסלול מותאם אישית, עם שקיפות מלאה בכל נקודה בדרך. לפני כל החלטה תדעו מה עומד לקרות, כמה זה עולה ולמה זו ההמלצה שלי.
זמינות מלאה, טיפול מהיר גם במקרים המורכבים ביותר – וללקוחות שלי חסכתי חיסכון של מיליוני שקלים לאורך הדרך.
                </p>
              </ScrollReveal>
