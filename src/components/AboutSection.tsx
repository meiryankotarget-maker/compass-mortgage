        ...
        >
          ...
          <span className={`text-[8px] font-semibold whitespace-nowrap transition-colors duration-300 ${isActive ? "text-accent" : "text-muted-foreground"}`}>
            ...
            <div className="order-1 lg:order-2">
              ...
              במצפן משכנתאות אנו מעניקים ייעוץ משכנתאות ותכנון פיננסי עם ניסיון מתוך המערכת הבנקאית והיכרות עמוקה עם השוק. אנו מכירים את השיקולים והדרך שבה הבנקים מקבלים החלטות, ויודעים בדיוק איפה יש מרחב לנהל משא ומתן ואיפה פחות.

הניסיון הזה מאפשר לנו לזהות מי מבין הבנקים הכי מתאים לכל עסקה. לכל בנק מדיניות שונה וקריטריונים שונים לאישור משכנתאות – ואנו יודעים עם מי נכון לעבוד כדי להשיג את התוצאה הטובה ביותר.

כל לקוח מקבל מסלול מותאם אישית ושקיפות מלאה בכל שלב: תדעו מראש מה עומד לקרות, כמה זה עולה ולמה זו ההמלצה שלנו.

במצפן משכנתאות תקבלו זמינות מלאה, טיפול מהיר גם במקרים מורכבים, וליווי מקצועי שחוסך ללקוחותינו מיליוני שקלים מצטברים לאורך הדרך.
                </p>
              </ScrollReveal>
